  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="dark:text-white font-bold text-2xl text-black mb-2 md:mb-3"> Confirm Deletion
          </h1>
          <p className="font-medium text-[13px] mb-5 text-gray"> Are you sure you want to delete invoice #{id}? This action cannot be
            undone.
          </p>
