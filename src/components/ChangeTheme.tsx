...
const ChangeTheme = () => {
  ...
  return (
    <button
      ...
      className=" text-blue lg:hover:text-lightGray flex justify-between items-center"
    >
      {mode !== "dark" ? (
        ...
        fill="none"
          ...
          <path d="M5.81724 0.900391C3.1055 0.900391 0.899414 3.10691 0.899414 5.81865C0.899414 8.53039 3.1055 10.7369 5.81724 10.7369C8.52854 10.7369 10.7351 8.53083 10.7351 5.81865C10.7351 3.10648 8.52854 0.900391 5.81724 0.900391Z"
            fill="currentColor"
          />
        </svg>):(
        <svg width="20" height="20"
