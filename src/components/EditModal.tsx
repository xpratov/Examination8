...
const inputKeys = ["address","author","city","clientAddress","clientCity","clientCode","clientCountry","clientName","code","country","email","id","invoiceDate","items","paymentTerms","project","type",];
...
const EditModal = () => {
  ...
  return (
    <>
      ...
      >
        <span
          className="flex md:hidden gap-3 items-center cursor-pointer md:mb-12 mb-8 lg:hover:text-gray dark:text-white text-black "
          onClick={() => closeModal()}
        >
