...
const SingleCheckbox = ({text,checked,setChecked,}: {text: string;checked: string;setChecked: (a: string) => void;}) => {
  return (
    <li
    ...
    >
      <div className="h-6 w-6 border-[2px] group-hover:bg-purple rounded-sm border-[transparent] group-hover:border-purple">
        <p
          ...
          {checked === text && (<img src="/check.svg" alt="check" className="w-4" />)}
        </p>
      </div>
      <span>{text}</span>
    </li>
