...
const Actions = ({ data }: { data: any }) => {
  ...
  return (
    <div className="md:max-w-full md:mx-0 md:px-8 md:mb-6 md:py-6 lg:max-w-[730px] mb-4 p-6  rounded-lg bg-white dark:bg-darkBlue mx-auto grid grid-cols-1 md:grid-cols-[180px_334px] md:justify-between">
