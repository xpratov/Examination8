...
const Calculate = ({ data }: { data: { items: any[] } }) => {
  return (
    <div className="w-full overflow-hidden rounded-lg">
      ...
      <div className="hidden md:block p-8  bg-calc dark:bg-lightBlue">
      ...
      <div className="py-[26px] text-white dark:bg-black  px-6 bg-bg flex items-center justify-between">
